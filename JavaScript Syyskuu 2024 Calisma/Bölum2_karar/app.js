...
const sayi = Number(prompt("Dongu miktarini giriniz:")); // Hata alinmamasi icin prompt icindeki degeri number yapmaliyiz
...
while (not2 < 0 || not2 > 100) {
  ...
  not2 = Number(prompt("0-100 arasında bir not giriniz:"));
}
console.log("Giridiğiniz not 0-100 arasındadır");
